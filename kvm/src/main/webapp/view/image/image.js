...
$("#uploadImage").click(function (){
	parent.layer.open({
		...
		resize:false,
		shade: 0,
		content: ['view/image/win/uploadImage.html', 'no'],
		title:'上传镜像',
		maxmin:true,
		area : [ '500px', '350px' ]
...
//下载镜像
$("#downloadDriver").click(function (){
	var param = dtree.getNowParam("kvmImageTree").basicData;
	HyAjax.Post("/kvmServer/downloadKvmImage.action", {imagePath:param.imageAddr,imageName:param.imageName},function(result) {
		if(result.success){
